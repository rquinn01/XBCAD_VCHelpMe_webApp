...
const StudentHubQuery = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        const queryRef = ref(database, "Student Hub Queries");
      ...
      alert("Student Hub Query submitted successfully!");
...
export default StudentHubQuery;
